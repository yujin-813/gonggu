...
export async function PATCH(request: NextRequest, { params }: Ctx) {
  ...
  const allowed: (keyof Post)[] = ['published','title','brand','price','origPrice','start_date','deadline','cat','img','url','account']
...
export async function PUT(request: NextRequest, { params }: Ctx) {
  ...
  const allowed: (keyof Post)[] = ['title','brand','account','cat','price','origPrice','start_date','deadline','img','url','caption','published']
