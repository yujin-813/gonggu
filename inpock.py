...
_CAT_KEYWORDS: list[tuple[str, tuple[str, ...]]] = [
    ("pet",     ("강아지", "고양이", "반려견", "반려묘", "반려동물", "펫", "사료", "간식펫", "켄넬", "리드줄")),
    ("kids",    ("아이", "어린이", "유아", "아기", "키즈", "초등", "영아", "육아", "그림책", "동화책",
                 "교구", "완구", "장난감", "학습지", "워크북", "문제집", "독서", "리더기", "돌봄",
                 "신생아", "베이비", "유아복", "어린이책", "보드북", "동요", "동화")),
    ("digital", ("핸드폰", "스마트폰", "태블릿", "노트북", "이어폰", "헤드폰", "충전기", "케이블",
                 "카메라", "가전", "전자기기", "디지털", "컴퓨터", "모니터", "키보드", "마우스")),
    ("beauty",  ("화장품", "스킨케어", "로션", "세럼", "앰플", "마스크팩", "선크림", "파운데이션",
                 "립", "아이섀도", "클렌징", "미백", "수분크림", "뷰티", "기초화장", "색조",
                 "향수", "에센스", "토너", "선스틱", "비비크림")),
