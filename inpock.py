...
NON_DEAL_KW = (
    ...
    "문의하기", "네이버톡톡", "톡톡",
    "레시피북",
    "자주 묻는 질문", "자주묻는질문", "qna", "q&a", "faq",
    "정품등록", "정품 등록", "제품등록", "제품 등록",
)
...
_CAT_KEYWORDS: list[tuple[str, tuple[str, ...]]] = [
    ("kids",    ("어린이", "유아", "아기", "키즈", "초등", "영아", "육아", "그림책", "동화책",
                 ...
                 "아이들", "아이옷", "아이용", "줄글책", "카시트", "유모차", "젖병", "기저귀",
                 "이유식", "쪽쪽이", "속싸개", "배냇저고리", "어린이집", "유치원", "돌잔치",
                 "아동복", "아동화", "미취학")),
...
# 삭제된 카테고리(패션·반려동물·디지털)에 걸리던 상품은 이제 남은 카테고리 중 아무것도
# 매칭 안 되면 life(생활)로 자동 편입된다 — classify_category() 마지막 return "life" 참고
